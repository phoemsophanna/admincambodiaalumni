...
const PrivacyPolicy = () => {
	document.title = "Donation Terms and Privacy | Admin & Dashboard";
	...
	useEffect(() => {
		dispatch(getSiteSetting("DONATION_TERM"));
		return () => {
	...
	return (
		<React.Fragment>
			<div className="page-content">
				<Container fluid>
					<BreadCrumb title="Donation Terms and Privacy" pageTitle="Dashboard" pageLink="/" />
					<Row>
						<Col xl={12}>
							<Form
								onSubmit={(e) => {
