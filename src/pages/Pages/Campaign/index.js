				...
				Cell: (campaign) => (
					<>
						{campaign.row.original.status === "PENDING" ? (
							...
							<span className="badge bg-success-subtle text-success">REJECTED</span>
						) : campaign.row.original.status === "FAILED" ? (
							<span className="badge bg-success-subtle text-success">FAILED</span>
						) : campaign.row.original.status === "INACTIVE" ? (
							<span className="badge bg-success-subtle text-success">INACTIVE</span>
						) : null}
					</>
				),
			},
