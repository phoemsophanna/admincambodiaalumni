...
export const TEAM_MANAGEMENT_URI = "/teams";
export const PROJECT_MANAGEMENT_URI = "/projects";
export const CAMPAIGN_MANAGEMENT_URI = "/campaigns";
export const WITHDRAW_MANAGEMENT_URI = "/withdraws";
export const TESTIMONIAL_URI = "/testimonials";
export const TECHNOLOGY_URI = "/partners";
